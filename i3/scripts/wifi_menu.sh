...
function initialization() {
	...
	TOKILL=$!
	if [[ -f "$DIR/networkmenu.conf" ]]; then
		source "$DIR/networkmenu.conf"
	elif [[ -f "$HOME/.config/rofi/networkmenu.conf" ]]; then
		source "$HOME/.config/rofi/networkmenu.conf"
	fi
	if [[ -f "$DIR/networkmenu.rasi" ]]; then
		RASI_DIR="$DIR/networkmenu.rasi" 
	elif [[ -f "$HOME/.config/rofi/networkmenu.rasi" ]]; then
		RASI_DIR="$HOME/.config/rofi/networkmenu.rasi"
	fi
